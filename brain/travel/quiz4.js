const quizData = [
    {
      question: 'The Spanish steps can be found where?',
      options: [
        'Barcelona',
        'Rome',
        'Lisbon',
    ...
    {
        question: 'Where in Asia are the Chocolate Hills located?',
        options: [
          'Columbia',
          'Pakistan',
          'Japan',
      ...
      },
      {
        ...
        options: ['Batman', 'Fast and Furious', 'Gladiator', 'Superman II'],
        answer: 'Superman II',
      },
  ];
