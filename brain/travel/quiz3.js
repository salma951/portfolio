const quizData = [
    {
      question: 'Which Country has the most Muslims in the world?',
      options: [
        'Maldives',
        'Indonesia',
        'Iraq',
    ...
    {
      question: 'Which Countries flag has an AK47 on it?',
      options: [
        'Mozambique',
        'Mali',
        'Monaco',
    ...
    },
    {
      ...
      options: ['A Dolphin', 'A Centaur', 'A Mermaid', 'A Unicorn'],
      answer: 'A Unicorn',
    },
    {
      ...
      },
      {
        ...
        options: ['Nepal', 'Armenia', 'Turkey', 'Austria'],
        answer: 'Turkey',
      },
  ];
