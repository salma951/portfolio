const quizData = [
    {
      question: 'What does NASCAR stand for?',
      options: [
        'National Association for Sports Car Auto Racing',
        'Norwegian association for Stock Car Auto Racing',
        'Norwegian association for Sports Car Auto Racing',
        'National Association for Stock Car Auto Racing',
      ],
      answer: 'National Association for Stock Car Auto Racing',
    },
    {
      question: 'Who performed at the Super Bowl LV half time show in 2021?',
      options: [
        'Rihanna',
        'Bruno Mars',
        'Jennifer Lopez',
    ...
    },
    {
      ...
      options: ['10 yards', '11 yards', '12 yards', '13 yards'],
      answer: '12 yards',
    },
    {
        question: 'What is the most venomous snake in the worldIn darts, what is the highest score from a single dart?',
        options: [
          '30',
          '40',
          '50',
      ...
      },
      {
        ...
        options: ['Nellie Kim', 'Lavinia Miloșovici', 'Yelena Shushunova', 'Nadia Comăneci'],
