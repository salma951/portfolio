const quizData = [
    ...
    {
      question: 'Which country experiences the most lightning strikes in the world?',
      options: ['Indonesia', 'Nepal', 'Thailand', 'Venezuela'],
      answer: 'Venezuela',
    },
    {
      ...
      },
      {
        ...
        options: ['Iceland', 'Greeland', 'New Guinea', 'Ellesmere Island'],
        answer: 'Greenland',
      },
  ];
