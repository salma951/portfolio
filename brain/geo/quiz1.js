const quizData = [
    {
      ...
      options: ['The River Nile', 'Amazon River', 'Yellow River', 'Yangtze River'],
      answer: 'The River Nile',
    },
    {
      question: 'What is the smallest country in the world by population?',
      options: ['Nauru', 'Tuvalu', 'Vatican city', 'Liechtenstien'],
      answer: 'Vatican city',
    },
    {
      question: 'What type of leaf is on the Canadian flag?',
      options: ['Maple leaf', 'Oak leaf', 'Rose leaf', 'Mango leaf'],
      answer: 'Maple leaf',
    },
    {
