const quizData = [
    ...
    },
    {
      ...
      options: ['Pancreas', 'Kidney', 'Liver', 'Gall bladder'],
      answer: 'Liver',
    },
    {
      ...
      {
        question: 'Bio-chemical compounds are used as ______?',
        options: [
          'Skin treatments',
          'Food preservatives',
          'Cooking oils',
      ...
      {
        question: 'Detergent is defined as a _____?',
        options: ['Liquid soluble', 'Liquid solvent', 'Liquid surfactant', 'Liquid solution'],
        answer: 'Liquid surfactant',
      },
  ];
