const quizData = [
    {
      question: 'A group of hedgehogs is called what?',
      options: [
        'A pack',
        'A school',
        'A prickle',
    ...
    },
    {
      ...
      options: ['A pack', 'A prickle', 'A business', 'A school'],
      answer: 'A business',
    },
    {
      ...
      {
        question: 'Which land animal can\'t jump?',
        options: ['Cheetah', 'Lioness', 'Elephant', 'Jaguar'],
        answer: 'Elephant',
      },
  ];
