const quizData = [
    ...
    },
    {
      ...
      options: ['Cheetah', 'Gazelle', 'Pronghorn', 'Elephant'],
      answer: 'Cheetah',
    },
    {
      question: 'Which bird is known for its ability to mimic sounds and human speech?',
      options: ['Hummingbird', 'Parrot', 'Owl', 'Hawk'],
      answer: 'Parrot',
    },
    {
      question: 'What is the primary diet of pandas?',
      options: ['Leaves', 'Fish', 'Bamboo', 'Ants'],
      answer: 'Bamboo',
    },
    {
      question: 'Which animal is known as the largest mammal in the world?',
      options: [
        'Elephant',
        'Hippopotamus',
        'Rhinoceros',
    ...
    },
    {
      ...
      options: ['Snail', 'Slug', 'Sloth', 'Tortoise'],
      answer: 'Sloth',
    },
  ];
