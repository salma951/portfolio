const quizData = [
    {
      ...
      options: ['Jupiter', 'Neptune', 'Saturn', 'Venus'],
      answer: 'Saturn',
    },
    {
      question: 'Acrophobia is the fear of what?',
      options: ['Acrobatics', 'Ships', 'Heights', 'Public speaking'],
      answer: 'Heights',
    },
    {
      question: 'Who was the Ancient Greek God of the Sun?',
      options: ['Zeus', 'Apollo', 'Demeter', 'Poseidon'],
      answer: 'Apollo',
    },
    {
    ...
    },
    {
      ...
      options: ['Calligraphy', 'Decorative arts', 'Mixed media', 'Printmaking'],
      answer: 'Calligraphy',
    },
  ];
