const quizData = [
    ...
    {
      question: 'The most common format for a home video recorder is VHS. VHS stands for ______?',
      options: ['Video Home System', 'Voltage house standard', 'Very high speed,', 'Video horizontal standard'],
