const quizData = [
    {
      ...
      options: [
        ...
        'Programmable list computing',
      ],
      answer: 'Programmable Logic Controller',
    },
    {
      question: 'When measuring the characteristics of a small-signal amplifier, say for a radio receiver, one might be concerned with its "Noise ____"?',
      options: [
        'Force',
        'Fall',
        'Figure',
    ...
    },
    {
      ...
      options: ['Data Block', 'Database', 'Double Byte', 'Driver Boot'],
      answer: 'Database',
    },
    {
      ...
      },
      {
        ...
        options: ['URL (Universal Resource Locator)', 'LAN (Local Area Network)', 'WWW (World Wide Web)', 'WAN (Wide Area Network)'],
