const quizData = [
    ...
    {
      question: '"FET" is a type of transistor, Its full name is ______ Effect Transistor?',
      options: [
        'Field',
        'Factor',
        'Flash',
    ...
    },
    {
      ...
      options: ['Command Description', 'Change Data', 'Compact Disc', 'Copy Density'],
      answer: 'Compact Disc',
    },
    {
      ...
      },
      {
        ...
        options: ['Artificial Intelligence', 'Anti Intelligence', 'Anti Information', 'Artificial Information'],
