const quizData = [
    {
      ...
      options: ['1880s', '1930s', '1950s', '1950s'],
      answer: '1880s',
    },
    {
    ...
    },
    {
      ...
      options: ['Order of Significance', 'Open Software', 'Optical Sensor', 'Operating System'],
      answer: 'Operating System',
    },
    {
      question: '".MOV" extension refers usually to what kind of file?',
      options: ['Animation/movie file', 'Image file', 'MS office document', 'Audio file'],
    ...
    },
    {
      ...
      options: ['Jeff Bezos', 'Alan Turing', 'George Boole', 'Charles Babbage'],
      answer: 'Alan Turing',
    },
  ];
