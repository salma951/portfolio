const quizData = [
    ...
    {
      question: 'Which pop star accidentally set fire to her home gym with candles?',
      options: ['Britney Spears', 'Rihanna', 'Lorde', 'Raye'],
    ...
    },
    {
      ...
      },
      {
        ...
        options: [
          'In the orange stand',
          'In the pineapple stand',
          'In the apple stand',
          'In the banana stand',
        ],
        answer: 'In the banana stand',
      },
      {
        question: 'Kim Kardashian and Kris Humphries were married for how many days?',
        options: ['70 days', '71 days', '72 days', '73 days'],
        answer: '72 days',
      },
  ];
